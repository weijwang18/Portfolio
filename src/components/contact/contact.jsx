...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_ll83p5k", "template_aww5avc", form.current, "z0U3-4c6PSThI86S6")
	e.target.reset()
  };
  return (
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">weijwang18@gmail.com</span>

              <a href="mailto:weijwang18@gmail.com" className="contact_button">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">(747)-300-6364</span>

              <a href="tel:7473006364" className="contact_button">
                Call me <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
            </div>
          </div>
        </div>
